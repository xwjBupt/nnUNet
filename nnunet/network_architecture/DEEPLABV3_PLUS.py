...
class ResNet(nn.Module):
    def __init__(self, init_ch, block, layers, os=16):
        self.inplanes = 64
...
def Deeplabv3plus_res50(num_classes=3, os=16, pretrained=False):
    ...
    if pretrained:
        ...
        resnet50.load_state_dict(state_dict)
    model = Deeplabv3plus(
        backbone=resnet50, num_classes=num_classes, os=os, freeze_bn=False
    )
    return model


def Deeplabv3plus_res101(num_classes=3, init_ch=3, os=16, pretrained=False):
    resnet101 = ResNet(Bottleneck, [3, 4, 23, 3], os, init_ch=init_ch)
    if pretrained:
    ...
    model = Deeplabv3plus(
        backbone=resnet101, num_classes=num_classes, os=os, freeze_bn=False
    )
    return model


class DEEPLABV3_PLUS(SegmentationNetwork):
    def __init__(
        self,
        num_classes=1,
        init_ch=3,
        ...
        **kwargs
        ...
        self.name = "DEEPLABV3_PLUS_RES101"
