...
def get_edges(targets, erode_kernel_size=5, dilate_kernel_size=5):
    erode_edges_all = []
    dilate_edges_all = []
...
class nnUNetTrainer(object):
    def __init__(
        ...
        self.print_to_log_file("make output dir as \n {}".format(self.output_folder))
    ...
    def initialize(self):
        if not self.was_initialized:
            ...
            self.print_to_log_file("Using Network as {}".format(self.network))
    ...
    def build_network_architecture(
        ...
        if arc == "undeclared":
            ...
            return get_custom_network_from_plans(
                arc,
                plans_manager,
                dataset_json,
                configuration_manager,
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        inference_gaussian = torch.from_numpy(
            compute_gaussian(self.configuration_manager.patch_size, sigma_scale=1.0 / 8)
        )
            ...
            for k in dataset_val.keys():
                ...
                if next_stages is not None:
                    for n in next_stages:
                        ...
                        if should_i_save_to_file(
                            prediction, results, segmentation_export_pool
                        ):
