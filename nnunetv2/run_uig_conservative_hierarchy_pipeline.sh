...
CONFIG_NAME="segmamba_uig_dec2_logit_boundary_hierarchy_detach_margin_asym_128x96x96"
TRAINER_NAME="nnUNetTrainerSegMambaUIGStableHierarchyConservative"

"${NNUNET_ENV_BIN}/python" \
  "${REPO_DIR}/nnunetv2Extention/SegMamba_V2_UIG/prepare_conservative_hierarchy_plans.py" \
