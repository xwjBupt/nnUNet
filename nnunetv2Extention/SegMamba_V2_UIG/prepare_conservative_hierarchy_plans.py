...
PARENT_CONFIGURATION = "segmamba_uig_dec2_logit_boundary_128x96x96"
CONFIGURATION_NAME = (
    "segmamba_uig_dec2_logit_boundary_hierarchy_detach_margin_asym_128x96x96"
)


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Add the conservative hierarchy UIG experiment to Dataset515 plans."
    )
