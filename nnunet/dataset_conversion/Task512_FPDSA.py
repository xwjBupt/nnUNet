...
if __name__ == "__main__":
    ...
    base = "/home/user/skip/data/FPDSA-Split"
    # this folder should have the training and testing subfolders

    # now start the conversion to nnU-Net:
    task_name = "Task512_FPDSA"
    ...
    for t in tqdm(training_cases):
        ...
        input_image_file = join(images_dir_tr, t).replace(".png", ".jpg")

        output_image_file = join(
            target_imagesTr, unique_name
        )  # do not specify a file ending! This will be done for you
        output_seg_file = join(
            target_labelsTr, unique_name
        )  # do not specify a file ending! This will be done for you

        # this utility will convert 2d images that can be read by skimage.io.imread to nifti. You don't need to do anything.
        # if this throws an error for your images, please just look at the code for this function and adapt it to your needs
        convert_2d_image_to_nifti(
            input_image_file, output_image_file, is_seg=False, gray_img=True
        )
    ...
    for ts in tqdm(testing_cases):
        ...
        input_image_file = join(images_dir_ts, ts).replace(".png", ".jpg")
    ...
    > nnUNet_plan_and_preprocess -t 512 -pl3d None
    
    once that is completed, you can run the trainings as follows:
    > nnUNet_train 2d nnUNetTrainerV2 512 FOLD
