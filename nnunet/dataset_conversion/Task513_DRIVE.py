...
if __name__ == "__main__":
    ...
    for t in tqdm(training_cases):
        ...
        convert_2d_image_to_nifti(
            input_image_file, output_image_file, is_seg=False, gray_img=False
        )
    ...
    > nnUNet_plan_and_preprocess -t 513 -pl3d None
    
    once that is completed, you can run the trainings as follows:
    > nnUNet_train 2d nnUNetTrainerV2 513 all
